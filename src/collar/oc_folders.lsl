...
{
    string sPrompt = "[Folders]\n> Locks\n\nPath: "+g_sPath+"\n\n* The options in this dialog lock (check)  or unlock (uncheck) this folder and/or all subfolders within. This only affects the current folder. To unlock every folder and clear all locks, please see the main menu";
    list lButtons = [];
