...
menu_about(key id) {
    ...
    context+="\n\n"+about;
    context+="\n\nThe OpenCollar™ scripts were used in this product to an unknown extent. The OpenCollar project can't support this product. Relevant [https://raw.githubusercontent.com/OpenCollarTeam/opencollar/master/LICENSE license terms] still apply.";
