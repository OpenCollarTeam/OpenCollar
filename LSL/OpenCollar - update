...
string version_check_url = "https://raw.github.com/opencollar/OpenCollarUpdater/master/LSL/~version";
...
string news_url = "https://raw.github.com/opencollar/OpenCollarUpdater/master/news.md";
key news_request;
