...
NewURL()
{
    //llMessageLinked(LINK_SET, SEND_CMD_ALL_SUBS, "remotemenu:off", "");
    //llMessageLinked(LINK_SET, SEND_CMD_NEARBY_SUBS, "remotemenu:off", ""); // I do not think we need it as many times.
